...
public class Nine extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.getclass_9);
		goToNew();
		getIntentt();
	declaration();
	filter();
	...
	public void goToNew(){
		AlertDialog alertDialog = new AlertDialog.Builder(Nine.this).create();
		...
		if (v == check) {
			...
			os = new OutputStreamWriter(openFileOutput(
				...
				if(maxDays==6){
					...
					os.close();
					Intent intent = new Intent(Nine.this, Calender.class);
					intent.putExtra("maxDays",maxDays);
					intent.putExtra("variety",9);
