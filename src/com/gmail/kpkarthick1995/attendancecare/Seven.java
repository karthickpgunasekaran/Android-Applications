...
public class Seven extends Activity implements OnClickListener,
	...
	private AutoCompleteTextView mon1,mon2, mon3, mon4, mon5, mon6, mon7;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.getclass_7);
		goToNew();
		getIntentt();
	    declaration();
	    filter();
	...
	public void goToNew(){
		AlertDialog alertDialog = new AlertDialog.Builder(Seven.this).create();
...
public void filter(){
	...
	public void getIntentt() {
		...
		Log.d("filter","seven maxdays:"+maxDays);
	}
	...
	public boolean checkFilter(){
		...
		else if(mon7.getText().toString().contains(" ")){
			tOrF=false;		
		}
		...
		if (v == check) {
			...
			os = new OutputStreamWriter(openFileOutput(
				...
				if(maxDays==6){
					...
					os.close();
					Intent intent = new Intent(Seven.this, Calender.class);
					intent.putExtra("maxDays",maxDays);
					intent.putExtra("variety",7);
					//Log.d("filter","seven")
