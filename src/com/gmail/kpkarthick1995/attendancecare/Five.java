...
public class Five extends Activity implements OnClickListener,
	...
	private AutoCompleteTextView mon1,mon2, mon3, mon4, mon5;
	private AutoCompleteTextView tue1, tue2, tue3, tue4, tue5;
	private AutoCompleteTextView wed1, wed2, wed3, wed4, wed5;
	private AutoCompleteTextView thu1, thu2, thu3, thu4, thu5;
	private AutoCompleteTextView fri1, fri2, fri3, fri4, fri5;
	private AutoCompleteTextView sat1, sat2, sat3, sat4, sat5;
	private Button sat;
...
private InputFilter filter;
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.getclass_5);
		goToNew();
		getIntentt();
	declaration();
	filter();
	...
	public void goToNew(){
		AlertDialog alertDialog = new AlertDialog.Builder(Five.this).create();
		...
		if (v == check) {
			...
			try {
				...
				if(maxDays==6){
					...
					os.close();
					Intent intent = new Intent(Five.this, Calender.class);
					intent.putExtra("maxDays",maxDays);
					intent.putExtra("variety",5);
